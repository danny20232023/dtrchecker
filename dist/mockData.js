...
// This file contains all the mock data for the DTR Checker application.
...
export const mockSchClass = [
  {
    ...
    CheckOutTime1: '12:00:00', // First expected check-out
    CheckInTime2: '13:00:00', // Second expected check-in
    CheckOutTime2: '17:00:00', // Second expected check-out
    LateMinutes: 15,
    EarlyMinutes: 15,
    CheckIn: 1,
    CheckOut: 1,
