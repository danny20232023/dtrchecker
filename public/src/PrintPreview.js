    ...
    import { mockDepartments } from './mockData'; // Import mockDepartments for user info

    // PrintPreview component displays a printable view of the DTR logs.
      ...
      return (
        <div className="min-h-screen bg-gray-100 p-4 sm:p-6 lg:p-8">
          <div className="max-w-5xl mx-auto bg-white p-6 sm:p-8 rounded-lg shadow-xl">
            {/* Buttons for printing and navigating back, hidden when actually printing */}
            <div className="flex justify-between items-center mb-6 print:hidden">
              ...
              <div className="flex space-x-3">
                <button
                  onClick={() => window.print()} // Triggers the browser's print dialog
                ...
                <button
                  onClick={onClose} // Closes the print preview and returns to dashboard
            ...
            {/* User Information displayed on the printout */}
            <div className="mb-6 flex items-center space-x-4 print:block print:mb-4">
                {user.PHOTO && (
                    <img
                        ...
                        onError={(e) => { e.target.onerror = null; e.target.src="https://placehold.co/60x60/CCCCCC/000000?text=N/A"; }} // Fallback for broken image
                    />
                )}
            ...
            <hr className="mb-6 print:hidden" /> {/* Separator, hidden when printing */}
              ...
              <div className="overflow-x-auto rounded-lg shadow print:shadow-none">
                <table className="min-w-full divide-y divide-gray-200 print:border print:border-gray-300">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200 print:bg-white">
                    {logs.map((day, index) => (
                      <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50 print:bg-white'}>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 print:text-gray-800">
                          {day.date}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 print:text-gray-700">
                          {day.checkin1}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 print:text-gray-700">
                          {day.checkin2}
